...
jQuery(document).ready(function($) {
    ...
    $(window).load(function() {
        if ($(".dt-sc-sponsor-carousel-wrapper").length) { $('.dt-sc-sponsor-carousel').carouFredSel({ responsive: true, auto: true, width: '100%', prev: '.sponsor-prev', next: '.sponsor-next', height: 'variable', scroll: 1, items: { width: 230, height: 'variable', visible: { min: 1, max: 4 } } }); }
        if ($(".dt-sc-testimonial-carousel-wrapper").length) { $('.dt-sc-testimonial-carousel').carouFredSel({ responsive: true, auto: false, width: '100%', prev: '.testimonial-prev', next: '.testimonial-next', scroll: 1, items: { width: 572, height: 'auto', visible: { min: 1, max: 1 } } }); }
    });
});
